...
";
  ...
  ";
        // line 20
        echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->renderVar($this->env->getExtension('Drupal\kint\Twig\KintExtension')->kint($this->env, $context, [0 => $this->sandbox->ensureToStringAllowed(($context["myparagraph"] ?? null))]));
        echo "
